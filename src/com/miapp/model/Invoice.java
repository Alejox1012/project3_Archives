...
public class Invoice {
   ...
   public Invoice(LocalDate returnDate, String clientName, Movie movie1, Movie movie2, Movie movie3, boolean hasMembership) {
    ...
    try (BufferedWriter writer = new BufferedWriter(new FileWriter(filePath))) {
        ...
        if (movie1 != null) writer.write("- " + movie1.getTitle() + " - Precio: $" + movie1.getRentalPrice() + "\n");
        if (movie2 != null) writer.write("- " + movie2.getTitle() + " - Precio: $" + movie2.getRentalPrice() + "\n");
        if (movie3 != null) writer.write("- " + movie3.getTitle() + " - Precio: $" + movie3.getRentalPrice() + "\n");
